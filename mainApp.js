...
function createWindow () {
  // 새로운 브라우저 창을 생성합니다. 
  win = new BrowserWindow({width: 800, height: 600,webPreferences:{nodeIntegration: false,preload:path.join(__dirname, './preload.js') }});
  // 그리고 현재 디렉터리의 index.html을 로드합니다.
  win.loadURL('http://192.168.20.93/works');
